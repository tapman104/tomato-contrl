...
* **OS-Level Input Injection**: Leverages the `enigo` crate to seamlessly inject relative mouse movements, clicks, and virtual keystrokes directly into the host operating system.
